        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentCategoryGuid = table.Column<Guid>(nullable: true),
                    ParentCategoryCulture = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Categories", x => new { x.Guid, x.Culture });
                    table.ForeignKey(
                        name: "FK_Categories_Categories_ParentCategoryGuid_ParentCategoryCulture",
                        columns: x => new { x.ParentCategoryGuid, x.ParentCategoryCulture },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => new { x.Guid, x.Culture });
                    table.ForeignKey(
                        name: "FK_Products_Categories_Guid_Culture",
                        columns: x => new { x.Guid, x.Culture },
                        principalTable: "Categories",
                        principalColumns: new[] { "Guid", "Culture" },
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_ParentCategoryGuid_ParentCategoryCulture",
                table: "Categories",
                columns: new[] { "ParentCategoryGuid", "ParentCategoryCulture" });
        }
